                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '84%' }}>
                        <div style={{display: 'flex', flexDirection: 'column'}}>
                            ...
                            <span style={{ fontSize: 14, fontFamily: 'Roboto', color: '#2C2C2C', width: 353, paddingTop: 5, lineHeight: 1.3 }}>Tháng 03/2013 - Rockwell Automation giới thiệu dòng sản phẩm Biến tần nhỏ gọn Allen-Bradley PowerFlex 525 AC Drive để giúp đơn giản hóa việc thiết kế…</span>
                        </div>
                        <div style={{display: 'flex', flexDirection: 'column'}}>
