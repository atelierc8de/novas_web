        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column' }}>
                <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
                    ...
                    <div style={{ width: 535, display: 'flex', justifyContent: 'center', flexDirection: 'column', height: 444, alignItems: 'flex-start' }}>
                        <p style={{ fontFamily: 'Roboto', fontSize: 32 }}><b>Giới thiệu</b></p>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-evenly', paddingTop: 80 }}>
                    ...
                    <div style={{ width: 535, display: 'flex', flexDirection: 'column', height: 444, alignItems: 'flex-start', justifyContent: 'center' }}>
                        ...
                        <div style={{ fontFamily: 'Roboto', fontSize: 15, display: 'flex', flexDirection: 'column', height: 444, justifyContent: 'space-between', lineHeight: 1.8 }}>
